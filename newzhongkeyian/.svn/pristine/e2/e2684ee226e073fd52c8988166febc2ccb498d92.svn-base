      ...
      <el-container>
        <el-header class="query_headbox">
          ...
          <retrieval class="query_head">
            <inpbox :inpb="true">
              <el-select v-model="param.gatewaystate" class="con-select qh_inp">
                <el-option
            ...
            <inpbox :inpb="true">
              <el-select v-model="param.gatetype" class="con-select qh_inp">
                <el-option
            ...
            <inpbox :inpb="true">
              <el-input
                ...
                placeholder="输入网关通讯ID/位置/唯一ID查询"
              ></el-input>
            </inpbox>
            <inpbox>
              <fel-button class="qh_btn" type="primary" @click="onRefreshSearch"
                >查询</fel-button
              >
...
export default {
  ...
  methods: {
    ...
    routeSearch() {
      console.log("this.toRoute.params", this.toRoute.params);
      if (
        this.toRoute.params &&
    ...
    add() {
      if (Object.keys(this.paramObj.build).length == 0) {
        this.$message({
          showClose: true,
          message: "请先选中左侧区域",
          type: "warning",
        });
      } else if (this.paramObj.build.buildtype != 3) {
        this.$message({
          showClose: true,
          message: "网关位置必须为楼层!",
          type: "warning",
        ...
        this.addParam = this.paramObj.build;
        this.dialogAdd = true;
      }
    },
    delete(arr) {
    ...
    onEjectChange() {
      this.$common.onEjectChange(this.list, "wggl307");
    },
    getEject() {
      this.$common.getEject(this, "list", "wggl307");
    },
  },
};
</script>
