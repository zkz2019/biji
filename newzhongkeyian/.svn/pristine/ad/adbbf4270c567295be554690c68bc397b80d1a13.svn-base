<template>
  ...
  >
    <el-container class="dialog-table6 query_main">
      <paging-table
        interface="/system/device/deviceyxlock/upload/3/getuploaddevicelock"
        :list="list"
        :param="param"
        :refresh="refresh"
      >
    ...
    >
      <el-container class="dialog-table6 query_main">
        <paging-table
          interface="/system/device/deviceyxlock/upload/4/getuploaddevicelockdetails"
          :list="detailedList"
          :param="detailedParam"
    ...
    >
      <el-container class="dialog-table6 query_main">
        <paging-table
          interface="/system/device/deviceyxlock/upload/5/getuploaddeviceorderdetails"
          :list="instructList"
          :param="detailedParam"
