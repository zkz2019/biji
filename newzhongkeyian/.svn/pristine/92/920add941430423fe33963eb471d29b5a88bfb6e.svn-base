<template>
  ...
  >
    <el-container class="dialog-table6 wh100">
      ...
      <paging-table
        interface="/system/onlineup/wxlockversionup/4/getautoversionuprooms"
        :list="listInfo"
        :param="param"
...
<script>
import wxLockProcessDetails from "./wxLockProcessDetails.vue";
export default {
  props: {
  ...
  components: { wxLockProcessDetails },
  data() {
    let $this = this;
    return {
  ...
  methods: {
    ...
    onAction(data, obj) {
      this.$ajax(
        "/system/onlineup/savewxgateversion/9/stopautogateup",
        data,
        "1",
        obj,
        true
