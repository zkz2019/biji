<template>
  ...
  >
    <el-container class="dialog-table6 wh100">
      ...
      <paging-table
        interface="/system/onlineup/yxlockversionup/4/getautoversionuprooms"
        :list="listInfo"
        :param="param"
        ref="paging-table"
...
<script>
import yxLockProcessDetails from "./yxLockProcessDetails.vue";
export default {
  props: {
  ...
  components: { yxLockProcessDetails },
  data() {
    let $this = this;
    return {
  ...
  methods: {
    ...
    onAction(data, obj) {
      this.$ajax(
        "/system/onlineup/saveyxlockversion/c/stopautoyxlockup",
        data,
        "1",
        obj,
        true
