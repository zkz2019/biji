  ...
  <el-container class="zwlrjgl310">
    <el-header class="query_headbox">
      ...
      <retrieval class="query_head">
        <inpbox :inpb="true">
          <el-select v-model="param.fpstate" class="con-select qh_inp">
            <el-option
...
export default {
  ...
  data() {
    let $this = this;
    return {
      fpstates: [{ fpstate: "", statename: "全部状态" }],
      loading: false,
      count: 0,
      setvals: null,
      dialogHistory: false,
      ...
      list: [
        ...
        },
        {
          ...
          template: {
            props: ["scope"],
            template: `<span :class='scope.row.fponline=="在线"?"puc-pg":"puc-px"'>{{scope.row.fponline}}</span>`,
          },
        },
        {
          name: "操作",
  ...
  methods: {
    ...
    delete(arr) {
      this.$confirm("此操作将删除当前采集器, 是否继续?", "提示", {
    ...
    onEjectChange() {
      this.$common.onEjectChange(this.list, "zwlrjgl310");
    },
    getEject() {
      this.$common.getEject(this, "list", "zwlrjgl310");
    },
  },
};
</script>
