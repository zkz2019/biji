          ...
          <retrieval class="query_head">
            <inpbox :inpb="true">
              <el-input
                ...
                :placeholder="'输入组织编号/名称查询'"
              ></el-input>
            </inpbox>
            <inpbox>
              <fel-button class="qh_btn" type="primary" @click="inSearch(false)">查询</fel-button>
...
export default {
  ...
  methods: {
    ...
    submitForm(data) {
      //提交表单事件 添加及修改
      if (this.ortype == 1) {
        this.$ajax("/system/group/savegroup/2/savegroup", data, "1", {}, true)
          .then((res) => {
            this.refreshData();
            this.$message({
              message:
        ...
        this.$ajax(
          "/system/group/updategroup/2/updategroup",
          data,
          "1",
          {},
          true
