...
<template>
  ...
  >
    <el-container class="dialog-table6 wh100">
      ...
      <paging-table
        interface="/system/onlineup/yxgateversionup/1/getyxgateversionup"
        ref="paging-table"
        :list="list"
        :param="param"
        :refresh="refresh"
    ...
    <yxVupDetails :dialogVisible="DetailsVisible" :duid="duid" @beforeClose="DetailsVisible=false"></yxVupDetails>
  </el-dialog>
</template>

<script>
import yxVupDetails from "./yxVupDetails";
export default {
  props: {
