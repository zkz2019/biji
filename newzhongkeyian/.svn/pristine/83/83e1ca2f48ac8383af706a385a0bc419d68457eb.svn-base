      ...
      <el-container>
        <el-header class="query_headbox">
          ...
          <retrieval class="query_head">
            ...
            <inpbox :inpb="true">
              <el-select v-model="param.roomtxtype" class="con-select qh_inp">
                <el-option
            ...
            <inpbox :inpb="true">
              <el-input
                ...
                placeholder="输入位置/房间名称/IMEI/唯一ID查询"
              ></el-input>
            </inpbox>
            <inpbox>
        ...
        <guideFile
          ...
          historyUrl="/system/device/devicenblock/upload/8/downhistory"
...
export default {
  ...
  methods: {
                ...
                arr.forEach((obj) => {
                  ...
                  if (vid == "365") {
                    this.importButs.push({
                      name: valias,
                      tempUrl: "",
                      url: "/system/device/devicenblock/upload/b/uploadnb",
                      //老接口 "/system/device/devicenblock/upload/2/uploaddevicenblock",
                    ...
                    this.exportButs.push({
                      ...
                      name: valias,
                      url:
                        "/system/device/devicenblock/upload/7/downdevicelocks",
                      data: this.param,
                    });
                  } else if (vid == "366") {
    ...
    onRefresh() {
      ...
      //   this.param.lockstate = this.lockState.join(",");
      // }
    ...
    onEjectChange() {
      this.$common.onEjectChange(this.list, "nblots361");
    },
    getEject() {
      this.$common.getEject(this, "list", "nblots361");
    },
  },
};
</script>
