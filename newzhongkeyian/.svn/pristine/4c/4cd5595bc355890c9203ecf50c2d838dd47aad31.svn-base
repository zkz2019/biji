              ...
              >
                    ...
                    >
                      <template v-if="typeof(value.select) == 'string'">
                        <el-checkbox
                          v-for="(v, k) of selects[value.select]"
                          :key="k"
                          :label="typeof(value.svalue) == 'undefined' ? v.value : (value.svalue == '' ? v : v[value.svalue])"
                        >{{typeof(value.slabel) == 'undefined' ? v.label : (value.slabel == '' ? v : v[value.slabel])}}</el-checkbox>
                      </template>
                      <template v-else>
                        <el-checkbox
                          v-for="(v, k) of value.select"
                    ...
                    >
                      <template v-if="typeof(value.select) == 'string'">
                        <el-radio
                          ...
                          :key="k"
                          :label="typeof(value.svalue) == 'undefined' ? v.value : (value.svalue == '' ? v : v[value.svalue])"
                        >{{typeof(value.slabel) == 'undefined' ? v.label : (value.slabel == '' ? v : v[value.slabel])}}</el-radio>
                      </template>
                      <template v-else>
                        <el-radio
                          v-for="(v, k) of value.select"
                ...
                <template v-else-if="value.type == 'switch'">
                  <el-switch
                    ...
                    :disabled="value.disabled"
                    v-model="ruleForm[value.value]"
                    :width="value.switchWidth"
                    :active-color="value.activeColor"
                    :inactive-color="value.inactiveColor"
                    :active-text="value.activeText"
                    :inactive-text="value.inactiveText"
                  ></el-switch>
                </template>
                ...
                <template v-else-if="value.type == 'date'">
                  <el-date-picker
                    ...
                    :popper-class="value.popperClass || 'formDate'"
                    :placeholder="value.placeholder"
                    :format="value.format"
                    @change="(...arr)=>{formClick(arr,value.onChange)}"
                    :value-format="value.vformat || value.format"
