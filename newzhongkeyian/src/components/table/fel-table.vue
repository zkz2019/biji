                ...
                <template slot-scope="scope">
                  <template v-if="value.custom == 'buts'">
                    <fel-table-but
                      ...
                      :buts="value.value(scope)"
                    ></fel-table-but>
                  </template>
                  <template v-else-if="value.custom == 'color'">
                    <fel-table-color
                      :type="value.formatter ? value.formatter(scope) : ''"
                  ...
                  <template v-else-if="value.custom == 'num'">
                    <fel-num-but
                      custom
                      @click="(...arr)=>{customClick(value.click, scope ,arr)}"
                      :isJump="value.formatter ? value.formatter(scope) : false"
                      :value="customValue(value, scope)"
                    ></fel-num-but>
                  </template>
                  <template v-else-if="value.custom == 'input'">
                    <fel-table-input
                      v-model="scope.row[value.prop]"
                      :clearable="value.clearable"
                      :disabled="value.formatter ? value.formatter(scope) : false"
                    ></fel-table-input>
                  </template>
                </template>
              </el-table-column>
