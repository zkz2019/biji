      ...
      grantList2: [
        ...
        },
        {
          ...
          template: {
            ...
            computed: {
              name() {
                let value = this.scope.row.sfbdstatus;
                if (value == "0") {
                  return "正在授权";
                } else if (value == "1") {
                  return "授权成功";
