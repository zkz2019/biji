  ...
  >
    ...
    <el-container v-else>
      <el-header class="query_headbox">
        <com-title>
          <span class="navig" type="text" @click="toBatch">批量授权指纹</span>
          <i class="arrow"></i>
          添加批量授权
        </com-title>
      </el-header>
        ...
        <adjust class="batch-authori">
            ...
            <div class="b-center_box">
              ...
              <div v-else class="b-center_box_bottom">
                <fel-tree5
                  ...
                  key="group"
                  class="tree1"
                  interface="/arearoom/public/4/listAreaRoomFingerTree"
          ...
          <adjust-div class="b-right" dragLeft>
            ...
            <paging-table
              ...
              interface="/auth/fingercenter/fingerauth/8/getfingerauthpage2"
              :list="generateList"
  ...
  methods: {
    ...
    queryLastCard(type) {
      ...
      if (
        ...
        (this.cardbuild.person.length > 0 && this.queryDataDel.length == 0)
      ) {
        this.$message({
          message: "请先选择人员或组织",
          type: "warning",
