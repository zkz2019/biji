        ...
        <adjust class="batch-authori">
              ...
              <div class="b-left_box_bottom">
                ...
                <template v-else>
                  <paging-table
                    ...
                    interface="/access/v2.0/auth/o/getAppPerson"
          ...
          <adjust-div class="b-right" dragLeft>
            ...
            <paging-table
              ...
              interface="/access/v2.0/auth/p/getAccessAuthApp"
              :list="generateList"
              ajaxType="9"
    ...
    return {
      ...
      generateList: [
        ...
        },
        {
          name: "位置",
          formatter(row, a, b) {
            return row.aglocation + " - " + row.amname + " - " + row.adname;
          },
        },
      ],
      queryData: [],
      ...
      if (str == "0") {
        ...
        if (type == "1") {
          if (this.ryvalue) {
            ...
            this.loadText = "加载中...";
            this.$ajax(
              "/access/v2.0/auth/o/getAppPerson",
    ...
    onClick(key, data) {
      if (key == "0") {
        ...
        if (this.$refs["paging-table"].queryData.length == 0) {
          ...
          this.$ajax(
            "/access/v2.0/auth/q/saveAccessAuthApp",
            this.defaultData,
            "9",
            this.generateObj,
            "请求中...",
