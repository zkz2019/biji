        ...
        <adjust class="batch-authori">
            ...
            <div class="b-left_box">
              ...
              <div class="b-left_box_bottom">
                <template v-if="ryOrzz">
                  ...
                  >
                    <span type="text" class="b-left_box_bottom_title"
                      >待授权人员列表</span
                    >
                    <el-button
                ...
                <template v-else>
                  <paging-table
                    ...
                    interface="/auth/app/lotauth/3/getperson"
            ...
            <div class="b-center_box">
              <div class="box_top position_box">
                ...
                <!-- <div class="top-switch" @click="changePosiOrGro">
                  <i
                    :class="{'el-icon-arrow-left groupLeft':isGroup,'el-icon-arrow-right groupRight':!isGroup}"
                  ></i>
              ...
              <div v-if="!isGroup" class="b-center_box_bottom">
                <fel-tree1
                  class="tree1"
                  ref="tree1"
                  interface="/auth/app/lotauth/2/getbuildtree"
          ...
          <adjust-div class="b-right" dragLeft>
            ...
            <paging-table
              ...
              interface="/auth/app/lotauth/4/getappauthpage"
              :list="generateList"
...
export default {
  ...
  created() {
    this.inGetsonmenu();
    this.$ajax("/auth/app/lotauth/1/getgrouptree", {}, "1").then((res) => {
  ...
  data() {
    ...
    return {
      ...
      loadText: "",
      ryvalue: "",
      cardParam: { type: "1", search: "" }, //pgids: "",, pgids: ""
      defaultData: {
        sdate: "",
        edate: "",
        openstime: "00:00",
    ...
    onClick(key, data) {
      if (key == "0") {
        ...
        if (this.$refs["paging-table"].queryData.length == 0) {
          ...
          this.$ajax(
            "/auth/app/lotauth/5/saveappauth",
            this.defaultData,
            "1",
            this.generateObj,
            "请求中...",
