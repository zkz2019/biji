<template>
  ...
  >
    ...
    <el-input class="beizhuText" placeholder="输入授权备注,如为何授权,授权目的等" type="textarea" v-model="beizhu"></el-input>
...
export default {
  ...
  methods: {
    onSubmit() {
      this.$ajax(
        "/lock/operate/info/q/addRemark",
        { remarks: this.beizhu, authid: this.row.authid },
        "1"
      )
        .then((res) => {
          this.$message({
