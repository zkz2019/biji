      ...
      <retrieval class="query_head marpadbor0" style="min-width:1030px;">
        ...
        <inpbox inptext>
          <el-input
            ...
            :placeholder="'输入姓名/身份证号/操作账号进行查询'"
          ></el-input>
        </inpbox>
        <inpbox :inpb="true">
