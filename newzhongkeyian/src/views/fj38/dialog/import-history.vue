    ...
    <el-container class="dialog-table6 query_main">
      ...
      >
        <retrieval class="query_head">
          <inpbox :inpb="true">
            <el-select placeholder="全部导入类型" class="qh_inp" v-model="param.type">
  ...
  data() {
    ...
    return {
      ...
      types: [
        ...
        {
          id: "8",
          name: (this.getRoomtype2()()[2] || "公共房间") + "比对导入",
        },
      ],
      refresh: 0,
      detailedRefresh: 0,
      dialogDetailed: false,
      param: { type: "1,2,3,4,5,6", search: "" },
      param1: { uploadid: "" },
      getRoomtype2s: {},
