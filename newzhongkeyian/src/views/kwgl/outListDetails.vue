<template>
  ...
  >
    <el-container class="dialog-table6 query_main">
      <paging-table
        interface="/auth/cardcenter/card/5/listCardDelDetails"
        :list="listInfo"
        :param="param"
        ajaxType="9"
        :refresh="refresh"
      ...
      listInfo: [
        ...
        },
        {
          ...
          template: {
            ...
            computed: {
              name() {
                if (this.scope.row.cddstatus == "0") {
                  return "正在删除";
                } else if (this.scope.row.cddstatus == "-1") {
                  return "失败";
                } else {
                  return "成功";
                }
            ...
            methods: {
              getClass() {
                let value = this.scope.row.cddstatus;
                if (value == "1") {
                  return "puc-pg";
                } else if (value == "-1") {
                  return "puc-px";
