      ...
      <retrieval class="query_head">
        ...
        <inpbox :inpb="true">
          <el-input
            ...
            :placeholder="'输入门禁/门名称/' + getNumber() + '/姓名查询'"
          ></el-input>
        </inpbox>
        <inpbox>
      ...
      list: [
        ...
        },
        {
          ...
          template: {
            ...
            template: `<div >
      <el-button type="text" @click="onClick">{{scope.row.personname}}</el-button>
    </div>`,
          },
        },
        {
    ...
    inGetType() {
      ...
      this.$ajax("/analysis/accessrecord/b/getSearchType", {}, "9")
        .then((res) => {
          ...
          this.artype3s = [...this.artype3s, ...res.result.artype3s];
          this.artype2s = [...this.artype2s, ...res.result.artype2s];
          this.artypes = [...this.artypes, ...res.result.artypes];
        })
        .catch((err) => {
          console.log("err", err);
        });
