...
<template>
  <div>
    <position
      ...
      treeUrl5="/arearoom/public/7/listUserAreaTree"
    ...
    <position
      ...
      treeUrl5="/arearoom/public/1/listAreaTree"
...
export default {
  ...
  methods: {
    ...
    inDeleteuserroom() {
      this.$confirm("此操作将删除勾选的权限, 是否继续?", "提示", {
        ...
        .then(() => {
          ...
          if (this.type == 2) {
            obj.buildlist = this.leftArrs
              ? this.leftArrs.map(o => o.areaid + "")
              : [];
          } else {
            obj.buildlist = this.leftArrs
          ...
          this.$ajax(
            ...
            { userlogin: this.param.userlogin, type: this.type },
            "1",
            obj,
            true,
            30000
    ...
    inSaveuserroom() {
      ...
      if (this.type == 2) {
        obj.buildlist = this.leftArrsAdd
          ? this.leftArrsAdd.map(o => o.areaid + "")
          : [];
      } else {
        obj.buildlist = this.leftArrsAdd
