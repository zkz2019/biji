  ...
  <el-container>
    <el-header class="elheader query_headbox">
      ...
      <retrieval v-show="onShow" class="query_head">
        <inpbox :inpb="true">
          <el-select class="con-select qh_inp" v-model="param.serverid">
            <el-option
        ...
        <inpbox :inpb="true">
          <el-select class="con-select qh_inp" v-model="param.logtype" placeholder="全部事件">
      ...
      <retrieval v-show="onShow1" class="query_head">
        <inpbox :inpb="true">
          <el-select class="con-select qh_inp" v-model="param1.discid" placeholder="请选择">
            <el-option
              v-for="item in cipan"
              :key="item.discid"
              :label="item.cpname"
...
export default {
  ...
  methods: {
    ...
    onEjectChange(bool = false) {
      ...
      if (bool) {
        this.$common.onEjectChange(this.list, "fwq443-A");
      } else {
        this.$common.onEjectChange(this.list1, "fwq443-B");
      }
    },
    getEject() {
      this.$common.getEject(this, "list", "fwq443-A");
      this.$common.getEject(this, "list1", "fwq443-B");
    },
  },
};
</script>