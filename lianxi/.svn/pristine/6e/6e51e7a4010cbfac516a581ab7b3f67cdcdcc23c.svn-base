...
<template>
  ...
  >
    <el-container class="dialog-table6 wh100">
      ...
      <paging-table
        interface="/system/onlineup/nbversionup/1/getnbversionup"
        ref="paging-table"
        :list="list"
        :param="param"
        :refresh="refresh"
    ...
    <nbVupDetails :dialogVisible="DetailsVisible" :duid="duid" @beforeClose="DetailsVisible=false"></nbVupDetails>
  </el-dialog>
</template>

<script>
import nbVupDetails from "./nbVupDetails";
export default {
  props: {
