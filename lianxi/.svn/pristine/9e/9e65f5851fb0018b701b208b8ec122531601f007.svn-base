  ...
  <div class="effect-floor">
    <div class="roomBox">
      <div class="roomBox_title">
        <div>
          <h3 class="effect-title">{{buildinfo.buildlocation||'建筑列表'}}-{{buildinfo.buildname || '建筑'}}{{buildinfo.buildcode && buildinfo.buildcode != "0" ? ("(区域编号"+buildinfo.buildcode+")") : "" }}</h3>
        </div>
      </div>
