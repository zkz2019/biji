              ...
              listBut() {
                ...
                list.forEach((item) => {
                  ...
                  if (
                    ...
                    lists[1].push(item);
                  } else if (item.id == "712" || item.id == "713") {
                    lists[2].push(item);
                  } else if (item.id == "723" || item.id == "718") {
                    lists[3].push(item);
                  }
                });
                return lists;
  ...
  methods: {
    ...
    onStartnblockup(type, row = null) {
      ...
      switch (type) {
        case "1":
          text = "门锁下载";
          url = "/system/onlineup/savewxlockversion/1/startwxlockup"; //门锁下载
          break;
        case "2":
          text = "门锁续传";
          url = "/system/onlineup/savewxlockversion/3/restartwxlockup"; // 门锁续传
          break;
        case "3":
          text = "更新升级";
        ...
        case "10":
          text = "状态查询";
          url = "/system/onlineup/savewxlockversion/a/getstatus"; //状态查询
          break;
        case "11":
          text = "自动升级";
