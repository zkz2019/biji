  ...
  methods: {
    ...
    setRules() {
      if (this.param.userlogin) {
        ...
        this.formData[2].placeholder = "输入密码";
        this.formData[3].placeholder = "输入确认密码";
        if (this.$refs.felForm.rules.password.length == 1) {
