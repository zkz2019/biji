        ...
        <el-main class="padt0 query_main">
          ...
          >
            ...
            <template v-if="batchButs && batchButs.length > 0">
              ...
              ></batch-but>-->
              <fel-button type="text" :disabled="listArrs.length<=0" @click="onBatchClick">
                <i class="ficon-piliangcaozuo maR5"></i>批量下发指令
              </fel-button>
            </template>
          </paging-table>
        </el-main>
      ...
      list: [
        ...
        // },
        {
          ...
          template: {
            ...
            <el-button type="text" @click="onClick(scope.row)">{{scope.row.adallcount}}</el-button>
            </el-tooltip>`,
          },
        },
        {
          ...
          template: {
            ...
            methods: {
              onClick(obj) {
                if (this.scope.row.adallnocount > 0) {
            ...
            <el-tooltip placement="bottom-end">
              ...
              <el-button type="text" @click="onClick(scope.row)">{{scope.row.adallnocount}}</el-button>
            </el-tooltip>`,
          },
        },
        {
  ...
  computed: {
    getRouteParam() {
      ...
      return {
        ...
        amid: param.amid,
        next:
          param.toTarget && param.toTarget == "sfxx-mjglGrant" ? true : false,
      };
    },
  },
  methods: {
    toGrant(num = 0) {
      if (this.getRouteParam.next && this.sonmenu == 4) {
        setTimeout(() => {
          this.param = {
            adid: this.getRouteParam.adid,
            amid: this.getRouteParam.amid,
          };
