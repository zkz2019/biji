...
export default {
  ...
  methods: {
    ...
    personClick(arr, data) {
      if (this.param) {
        this.$ajax(
          "/system/device/deviceyxlock/order/8/getbatchno",
          this.param,
          "1",
          this.paramObj
        )
    ...
    inGetupdategatewayinfo() {
      if (this.param) {
        this.loading = true;
        this.$ajax(
          "/system/device/deviceyxlock/order/6/getdeploydevicelockinfo",
          this.param,
          "1",
          this.paramObj
        )
    ...
    submitForm(data) {
      ...
      let obj = Object.assign(
        {
          ...
          roombautrate: data.roombautrate,
      ...
      this.$ajax(
        "/system/device/deviceyxlock/order/7/savedeploydevicelockinfo",
        obj,
        "1",
        this.paramObj,
        true
