<template>
  ...
  >
    <el-container class="dialog-table6 wh100">
      ...
      <paging-table
        interface="/system/onlineup/yxgateversionup/4/getautoversionupgates"
        :list="listInfo"
        :param="param"
        :refresh="refresh"
        ref="paging-table"
...
<script>
import yxProcessDetails from "./yxProcessDetails.vue";
export default {
  props: {
  ...
  methods: {
    ...
    onAction(data, obj) {
      this.$ajax(
        "/system/onlineup/saveyxgateversion/9/stopautogateup",
        data,
        "1",
        obj,
        true
