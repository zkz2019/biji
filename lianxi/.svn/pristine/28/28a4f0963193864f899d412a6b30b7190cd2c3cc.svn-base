...
<template>
  <fel-admin
    ...
    :botButs="botButs"
    :paramObj="paramObj"
    leftInterfaceUrl="/system/build/savemanager/4/getnextuser"
    interfaceUrl="/system/build/savemanager/2/getnextareamanager"
    :leftList="fuList"
    :list="list"
...
export default {
  ...
  methods: {
    ...
    add() {
      this.$ajax(
        "/system/build/savemanager/9/saveareamanages",
        {},
        "1",
        this.aggregation,
        true
    ...
    delete(isdelson) {
      this.$ajax(
        "/system/build/deletemanager/3/delareamanages",
        {
          isdelson: isdelson
        },
        "1",
    ...
    savefatheruser() {
      if (this.param.length == 1) {
        this.$ajax(
          "/system/build/savemanager/5/savenextuser",
          {
