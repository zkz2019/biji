  ...
  <el-container class="zzwyxjk">
    ...
    <el-main class="elmin query_main">
      <paging-table
        ...
        interface="/system/control/yxlocklog/1/getlocklog"
        class="heig100"
        :param="param"
        :refresh="refresh"
    ...
    >
      <el-container class="dialog-table6 query_main">
        <paging-table
          height="100%"
          interface="/system/control/yxlocklog/save/1/getlock"
          class="card-paging"
    ...
    >
      <el-container class="dialog-table6 query_main">
        <paging-table
          noInti
          interface="/system/control/yxlocklog/info/3/getlockloginfo"
          :param="journalParam"
  ...
  methods: {
    ...
    submitForm() {
      if (this.gateway && this.gateway.length > 0) {
        this.$ajax(
          "/system/control/yxlocklog/save/2/savelocklog",
          {
    ...
    onClick(key, data, obj) {
      if (key == "6") {
        this.$ajax(
          "/system/control/yxlocklog/regain/1/regainlocklog",
          {
            llid: data.llid,
          },
          "1",
        ...
        this.$ajax(
          "/system/control/yxlocklog/info/2/getalllocklogdevice",
          {
            llid: data.llid,
          },
          "1"
    ...
    deleteJournal(data, ts) {
      this.$ajax(
        "/system/control/yxlocklog/delete/1/deletelocklog",
        { llid: data },
        "1",
        {},
        true
    ...
    onEjectChange() {
      this.$common.onEjectChange(this.list, "yxlwsyxjk477");
    },
    getEject() {
      this.$common.getEject(this, "list", "yxlwsyxjk477");
    },
  },
};
</script>