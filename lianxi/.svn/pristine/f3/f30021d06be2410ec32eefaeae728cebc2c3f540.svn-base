        ...
        },
        {
          ...
          buts: [
            ...
            },
            {
              ...
              popover: {
                content:
                  "范围：0-180分钟，代表一批次的NB锁将会离散到多少时间内发起心跳",
                placement: "right",
              },
        ...
        },
        {
          ...
          buts: [
            ...
            },
            {
              ...
              isPopover: true,
              popover: {
                content: "允许的方式被触发时，会上传锁内记录并获取最新授权",
                placement: "right",
              },
      ...
      if (this.param) {
        ...
        this.$ajax(
          ...
          .then((res) => {
            ...
            this.defaultData.roomisencryption = result.roomisencryption
              ? result.roomisencryption
