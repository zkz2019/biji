      ...
      list: [
        ...
        },
        {
          ...
          template: {
            ...
            methods: {
              onClick(val) {
                ...
                if (val == 1) {
                  $this.$router.push({
                    name: "卡务中心",
                    params: { in: "renyuan1", personcode: this.row.personcode },
                  });
                } else if (val == 2) {
                  $this.$router.push({
                    name: "指纹管理",
                  ...
                  $this.$router.push({
                    ...
                    params: {
                      name: "人脸数据管理",
                      personcode: this.row.personcode,
                    },
                  });
                }
                console.log("val", val);
            ...
            computed: {
              text() {
                return this.scope.row.allcount;
              },
              row() {
            ...
            >
            <div>
              <div><el-button type="text" @click="onClick(1)">卡片: {{row.cardcount}}</el-button></div>
              <div><el-button type="text" @click="onClick(2)">指纹: {{row.fingercount}}</el-button></div>
              <div><el-button type="text" @click="onClick(3)">人脸: {{row.facecount>0?'已录入':'未录入'}}</el-button></div>
            </div>
...

        {
          ...
          template: {
            ...
            template: `<div>
              <span v-if="isNumber(scope.row.accesscount)"><a class="a-click" @click.stop="onClick">{{scope.row.accesscount}}</a></span>
            ...
            methods: {
              onClick(key, obj, data) {
                if (key == 4) {
                  ...
                  $this.toFace(obj, this.scope.row);
                }
              },
              isShow(row, obj) {
                if (
              ...
              this.$ajax(
                ...
                .then((res) => {
                  this.$message({
                    message:
                      id == 5
                        ? this.choiceType + "成功,请在人员操作记录查看结果!"
                        : this.choiceType + "成功",
                    type: "success",
                  });
                  this.onRefreshTable();
