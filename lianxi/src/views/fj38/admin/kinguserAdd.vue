...
export default {
  ...
  watch: {
    dialogVisible(val) {
      if (val) {
        ...
        if (this.getIsFace()) {
          if (this.checkedroom.isfacelock == 1) {
            this.formData[15].noShow = false;
            this.formData[15].readonly = true;
            this.formData[15].type = "text";
            this.formData[15].placeholder = "";
          } else {
  ...
  methods: {
    ...
    onSearch() {
      ...
      if (obj.isface == 1) {
        this.formData[15].readonly = false;
        this.formData[15].type = "select";
        this.formData[15].placeholder = "请选择是否下发";
        this.$refs.felForm.rules.issendface = [
          {
            required: true,
            message: "请选择是否下发人脸",
            trigger: "change",
        ...
        this.formData[15].readonly = true;
        this.formData[15].type = "text";
        this.formData[15].placeholder = "暂无数据";
        this.$refs.felForm.rules.issendface = [];
      }
      if (obj.ispass == 1) {
        ...
        this.formData[13].placeholder = "请选择是否下发";
        ...
        this.formData[13].placeholder = "暂无数据";
        this.$refs.felForm.rules.issendpass = [];
      }
      if (obj.isapp == 1) {
      ...
      if (is) {
        ...
        console.log("obj,this.isselect", obj, this.isselect);
        this.defaultFormData = Object.assign(obj, {
          openstime: "00:00",
          openetime: "23:59",
          issendapp:
          ...
          issendfingerentry:
            obj.isfinger == 1
              ...
              : "",
          issendaddpass:
            obj.isaddpass == 1 ? (this.isselect.isselectpass ? "1" : "") : "",
          issendsweep:
            obj.issweep == 1 ? (this.isselect.isselectsweep ? "1" : "") : "",
        });
        if (obj.iscard == 1) {
    ...
    cardInput() {
      ...
      if (val) {
        ...
        this.formData[13].type = "text";
        this.formData[8].placeholder = "";
        this.formData[13].placeholder = "";
        // this.formData[14].type = "text";
        // this.formData[14].readonly = true;
        // this.formData[14].placeholder = "";
