  ...
  <el-container class="wgljjl314">
    <el-header class="elheader query_headbox">
      ...
      <retrieval class="query_head">
        ...
        <inpbox :inpb="true">
          <el-select v-model="param.msgtype" class="con-select qh_inp">
            <el-option
        ...
        <inpbox :inpb="true">
          <el-select v-model="param.sendtype" class="con-select qh_inp">
            <el-option v-for="item in sendtypes" :key="item.id" :label="item.name" :value="item.id"></el-option>
          </el-select>
        </inpbox>
        <inpbox :inpb="true">
          <el-input clearable class="wid150 qh_inp" v-model="param.pushid" placeholder="输入推送编号"></el-input>
        </inpbox>
        <inpbox :inpb="true">
          <el-input
            clearable
