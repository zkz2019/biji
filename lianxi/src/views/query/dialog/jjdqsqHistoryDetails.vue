<template>
  ...
  >
    <el-container class="dialog-table6 query_main">
      <paging-table
        interface="/analysis/expireauth/9/listExpireAuthRecordDetails"
        :list="listInfo"
        :param="param"
        ajaxType="9"
        :refresh="refresh"
      ...
      listInfo: [
        ...
        // },
        {
          ...
          template: {
            ...
            computed: {
              name() {
                if (this.scope.row.eardstatus == "0") {
                  return "正在删除";
                } else if (this.scope.row.eardstatus == "-1") {
                  return "失败";
                } else {
                  return "成功";
                }
            ...
            methods: {
              getClass() {
                let value = this.scope.row.eardstatus;
                if (value == "1") {
                  return "puc-pg";
                } else if (value == "-1") {
                  return "puc-px";
        ...
        },
        {
          ...
          template: {
            ...
            computed: {
              name() {
                if (this.scope.row.sendstatus == "1") {
                  return "下发成功";
