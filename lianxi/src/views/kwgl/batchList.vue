  ...
  <el-container>
      ...
      <retrieval class="query_head">
        ...
        <inpbox :inpb="true">
          <el-input
            ...
            :placeholder="'输入' + getNumber() + '/姓名/卡号查询'"
          ></el-input>
        </inpbox>
        <inpbox>
          <el-button @click="cardInput" class="qh_btn" type="primary"
            >查询</el-button
          >
    ...
    <el-main class="pad0 query_main">
      <paging-table
        ...
        height="100%"
        interface="/auth/cardcenter/cardauth/1/getcardauth"
    ...
    >
      <el-container class="dialog-table6 query_main">
        <paging-table
          v-if="grantType == 2"
          key="type2"
          interface="/auth/cardcenter/cardauth/3/getcardbackauthinfo"
          :param="grantParam"
        ...
        <paging-table
          v-else
          key="type1"
          interface="/auth/cardcenter/cardauth/2/getcardauthinfo"
          :param="grantParam"
          :refresh="grantRefresh"
          :refreshTable="grantRefreshTable"
          :list="grantList1"
  ...
  data() {
    ...
    return {
      ...
      grantList1: [
        ...
        // },
        {
          ...
          template: {
            ...
            computed: {
              name() {
                let value = this.scope.row.scedstatus;
                if (value == "0") {
                  return "正在授权";
                } else if (value == "1") {
                  return "授权成功";
      ...
      grantList2: [
        ...
        },
        {
          ...
          template: {
            ...
            methods: {
              getClass() {
                let value = this.scope.row.scbdstatus;
                if (value > 0) {
                  return "puc-pg";
                } else if (value < 0) {
                  return "puc-px";
      ...
      list: [
            ...
            methods: {
              ...
              onClick() {
                ...
                if (obj.sceid) {
                  ...
                  console.log("obj", obj);
                  if (obj.actiontype == 2) {
                    $this.titleList = "卡片删除授权列表";
                  } else {
                    $this.titleList = "卡片授权列表";
                  }
        ...
        //           if (obj.specialtype2 == 2) {
        //             $this.titleList = "卡片取消授权列表";
        //           } else {
        //             $this.titleList = "卡片授权列表";
        //           }
        //           $this.grantParam.sceid = obj.sceid;
  ...
  methods: {
    ...
    inReloadlotcard(type, sceid) {
      this.$confirm(
        ...
        .then(() => {
          let url = "/auth/cardcenter/lotauth/reload/1/reloadlotcardauth";
          if (type == 2) {
            url = "/auth/cardcenter/lotauth/reload/2/reloadlotcardbackauth";
          }
    ...
    onEjectChange() {
      this.$common.onEjectChange(this.list, "plsq385");
    },
    getEject() {
      this.$common.getEject(this, "list", "plsq385");
    },
  },
};
</script>
