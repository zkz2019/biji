<template>
  ...
  >
    <el-container class="dialog-table6 query_main">
      <paging-table
        interface="/system/device/devicelock/order/2/getlockorder"
        :list="list"
        :param="paramObj"
        :refresh="refresh"
      />
    ...
    >
      <el-container class="dialog-table6 query_main">
        <paging-table
          interface="/system/device/devicelock/order/3/getlockorderinfo"
          :list="detailedList"
          :param="detailedParam"
    ...
    >
      <el-container class="dialog-table query_main">
        <paging-table
          style="height:100%"
          interface="/system/device/devicelock/order/4/getlockorderchangeinfo"
          :list="changeList"
          :param="detailedParam"
