...
<template>
  <el-container>
    ...
    <yxAutoup :stopBtns="stopBtns" :dialogVisible="autoVisible" @beforeClose="autoVisible = false"></yxAutoup>
    <history
...
export default {
  ...
  watch: {
    ...
    versionVisible(val) {
      if (val) {
        console.log("this.upType", this.upType);
        if (this.upType == "8") {
