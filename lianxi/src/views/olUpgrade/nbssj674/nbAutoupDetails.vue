<template>
  ...
  >
    <el-container class="dialog-table6 wh100">
      ...
      <paging-table
        interface="/system/onlineup/nbversionup/4/getautoversionuprooms"
        :list="listInfo"
        :param="param"
        ref="paging-table"
...
<script>
import nbProcessDetails from "./nbProcessDetails.vue";
export default {
  props: {
  ...
  methods: {
    ...
    onAction(data, obj) {
      this.$ajax(
        "/system/onlineup/savenbversion/8/stopautonblockup",
        data,
        "1",
        obj,
        true
